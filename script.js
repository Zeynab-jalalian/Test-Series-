...
const resultsTWD = [
  {
   ...
   Rick رهبر  گروه است و همیشه سعی می‌کند با تصمیم‌های منطقی و شجاعانه، اعضای گروه را نجات دهد. او در شرایط بحرانی سریع تصمیم می‌گیرد و برای حفظ امنیت و منابع گروه بسیار متعهد است. تمرکز او همیشه روی جمع و اتحاد اعضاست و اهل ریسک‌های حساب‌شده است.
    `,
  },
  {
    key:"Daryl",
    ...
    داریل نماد استقلال و مهارت عملی است! شما با هوش عملی، سرعت عمل و تسلط بر شرایط سخت، هر تهدیدی را مدیریت می‌کنید. ترجیح می‌دهید در سکوت عمل کنید و بدون دنبال کردن رهبران، خودتان راه‌حل پیدا کنید. دیگران می‌دانند در کنار شما، هیچ خطری نمی‌تواند آن‌ها را شکست دهد؛ شما مرز بین خطر و امنیت هستید!
    `,
  },
   {
    key:"Carol",
    ...
    کارول استاد انعطاف و بقاست! شما می‌دانید چه زمانی باید سکوت کنید، چه زمانی باید وارد عمل شوید و چگونه با کمترین منابع بیشترین نتیجه را بگیرید. زیرکی، خلاقیت و توانایی پیش‌بینی خطرها، شما را به یکی از باارزش‌ترین اعضای گروه تبدیل می‌کند. در موقعیت‌های بحرانی، دیگران به اراده و تصمیم‌گیری دقیق شما اعتماد کامل دارند!
    `,
  }, {
    key:"Negan",
    name:"Negan Smith",
    image:"",
    description:`
    <span>شما شبیه نیگان هستید!</span>
    نیگان استاد استراتژی و تسلط بر قدرت است! شما کسی هستید که با برنامه‌ریزی و چیره‌دستی می‌توانید دیگران را تحت تأثیر قرار دهید و هر موقعیتی را به نفع خودتان مدیریت کنید. اراده و اعتمادبه‌نفس شما باعث می‌شود که حتی دشمنان نیز شما را دست‌کم نگیرند. شما بازیگر اصلی در شرایط پیچیده هستید و قدرت خود را به خوبی نشان می‌دهید!
    `,
  }, {
    key:"Maggie",
    name:"Maggie Rhee",
    ...
    مگی نماد امید و مقاومت است! شما کسی هستید که با روحیه قوی، پشتکار و وفاداری، حتی در سخت‌ترین شرایط گروه را هدایت می‌کنید. شما قادر هستید تصمیم‌های استراتژیک بگیرید و در عین حال با قلبتان از دیگران حمایت کنید. اطرافیانتان از شجاعت و توانایی شما در ایجاد انگیزه و همدلی، انرژی می‌گیرند!
    `,
  }, {
    key:"Michonne",
    ...
    میشون جنگجویی آرام، اما مرگبار است! شما با تمرکز کامل و مهارت رزمی عالی، تهدیدها را سریع و مؤثر مدیریت می‌کنید. شما به صورت مستقل عمل می‌کنید، اما همیشه حواستان به منافع گروه است. دیگران از قدرت، شجاعت و تصمیم‌های حساب‌شده شما هیجان‌زده می‌شوند و می‌دانند که در میدان خطر، شما بهترین محافظ هستید!
    `,
  }, {
    key:"Shane",
    name:"Shane Walsh",
    ...
    شین کسی است که سریع، جسور و انرژی‌بخش است! شما در لحظه تصمیم می‌گیرید و هیچ فرصتی را از دست نمی‌دهید. با شهامت و انگیزه بالا، دیگران را به عمل تشویق می‌کنید و می‌توانید در شرایط بحرانی باعث تغییر مسیر کل گروه شوید. البته گاهی ریسک‌های شما زیاد است، اما این جسارت باعث می‌شود همیشه در مرکز توجه و تصمیم‌گیری باشید!
    `,
  }, {
    key:"Glenn",
    name:"Glenn Rhee",
    ...
    گلِن نماد مهربانی، احساسات واقعی و سرعت عمل است! شما کسی هستید که با قلب مهربان و حساس خود، همیشه به دیگران اهمیت می‌دهید و آن‌ها را حمایت می‌کنید. همزمان فرز و دقیق عمل می‌کنید، تهدیدها را سریع شناسایی و مدیریت می‌کنید و توانایی حل مشکلات پیچیده را دارید. اطرافیان می‌دانند با شما می‌توانند بر هر چالشی غلبه کنند، چون شما ترکیبی از شجاعت، هوش و دل مهربان هستید!
    `,
  },
];
